#include "pico_hardware_interface/fake_robot.h"

#include "hardware_interface/types/hardware_interface_type_values.hpp"

FakeRobot::FakeRobot()
    : PicoHardware(rclcpp::get_logger("FakeRobot"))
{
}
...
return_type FakeRobot::configure(const hardware_interface::HardwareInfo &info)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("PicoHardware"), "Configuring...");
  ...
  RCLCPP_INFO(rclcpp::get_logger("PicoHardware"), "Finished Configuration");
...
{
  RCLCPP_INFO(rclcpp::get_logger("PicoHardware"), "Starting Controller...");
...
{
  RCLCPP_INFO(rclcpp::get_logger("PicoHardware"), "Stopping Controller...");
